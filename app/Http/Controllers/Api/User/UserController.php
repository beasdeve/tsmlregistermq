...
class UserController extends Controller
{
   ...
   public function store(Request $request)
   {
        ...
        try {
            ...
            $userData['is_tcs_tds_applicable'] = (!empty($request->is_tcs_tds_applicable)) ? $request->is_tcs_tds_applicable : '';
            $userData['first_name'] = "";
            $userData['last_name'] = "";
            ...
            if ($request->hasFile('address_proof_file'))
            {
             ...
             // Storage::disk('custom_folder_2')->put($filename,$image);
            // move_uploaded_file($filename, "../../../../../../login/storage/app/public/user/");
            ...
            $userData['id'] = $user->id;
            // $userData['address_proof_file'] = $request->address_proof_file;
            UserCreated::dispatch($userData);
            $addr = array();
